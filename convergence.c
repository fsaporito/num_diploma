...
//////////////////////////////////////////////////////////////////////////
	...
	fprintf (stdout, "[*] First Continuous Derivate? ");
...
//////////////////////////////////////////////////////////////////////////
	...
	int diffder=diff-2; // Second Derivate's Coefficient's Array's Lenght
	...
	for (i=1; i<k; i++) {
		...
		if ( (DerDer[i]*DerDer[0]) < 0. ) {
			fprintf (stdout, " \n");
			fprintf (stderr, "error: Second Derivate's Sign Not Continuous In The Intervalo !!!\n");
			sleep(3);
			break;
			return 6;
		}
...
//////////////////////////////////////////////////////////////////////////
	...
	if ( functiontype == 1 && dimension < 2 ) { return 7; }

	fprintf (stdout, "[*] Second Continuous Derivate? ");
